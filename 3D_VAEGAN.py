...
class Encoder(nn.Module):
    def __init__(self,channel,features):
        ...
        #self.conv5 = nn.Conv3d(self.features, args.features,4,2,1, bias=False)

        self.conv5_ = nn.Conv3d(args.features*4, args.features*5,4,2,1, bias=False)
        self.conv6 = nn.Conv3d(args.features*5, args.latent_z,4,2,1, bias=False) #3,1
    ...
    def forward(self,x,x1):
        ...
        x_= self.relu(self.batchNorm5(self.conv5_(x)))
